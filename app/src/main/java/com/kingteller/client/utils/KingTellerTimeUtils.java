...
public class KingTellerTimeUtils {
	...
	public static float getBeApartHour(String startTime, String endTime, int num){
		Date end = KingTellerTimeUtils.getConversionFormatDateByString(endTime, num);
		Date start = KingTellerTimeUtils.getConversionFormatDateByString(startTime, num);
